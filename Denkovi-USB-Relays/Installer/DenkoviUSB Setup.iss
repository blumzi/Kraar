...
DefaultDirName="{cf}\ASCOM\DenkoviUSB"
DisableDirPage=yes
DisableProgramGroupPage=yes
OutputDir="."
OutputBaseFilename="DenkoviUSB Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\DenkoviUSB"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\DenkoviUSB"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "c:\users\blumzi\documents\visual studio 2015\Projects\Manolis\Denkovi-USB-Relays\bin\Debug\ASCOM.DenkoviUSB.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "c:\users\blumzi\documents\visual studio 2015\Projects\Manolis\Denkovi-USB-Relays\Installer\ReadMe.html"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DenkoviUSB.Switch.dll"""; Flags: runhidden 32bit
